...
\subsection{Efficient Instantiation of SS-NIZK in ROM}\label{sec:nizk} 
In this section we provide efficient simulation sound NIZK proof systems in ROM for languages $L_3$ and $L_4$ that are used in our constructions. The languages are defined in the following way:
\[
