...
\subsubsection*{Requirements on Practical Timed Commitments}
...
\cite{cryptoeprint:2022/1498} - Section 4.3         & linear        & \xmark        & priv.          & \cmark        & \cmark         & $O(1)$           &    $O(1)$     & $O(1)$      & \cmark         \\
\cite{cryptoeprint:2022/1498} - Section 4.4         & mult.         & \xmark        & priv.          & \cmark        & \cmark         & $O(1)$           &  $O(1)$    & $O(1)$      & \cmark         \\
...
\cite{CCS:TCLM21}    & 2.32   & 3321.41 &   8846.96
 & 256 \\
\hline
\cite{cryptoeprint:2022/1498} - Section 4.3    & 1.92       & 1.54      & 1.55 & 3072 \\
%\ref{sec:linear-ROM}         & 1.92       & 1.54      & 1.55 & 3072 \\

\hline
\end{tabular}
\caption{\label{tab:comparison-NITC}Comparison of our construction \cite{cryptoeprint:2022/1498}(Section 4.3) with \cite{CCS:TCLM21} for security level $\secpar = 128$ bits and taking into account the security loss for $Q = T = 2^{32}$.}
\end{center}
\end{table}
