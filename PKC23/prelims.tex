...
\caption{\label{fig:sss} \label{fig:dcr}  Security experiments for the strong sequential squaring assumption (left) and DCR (right).}
\end{figure}
...
The proof of this lemma can be found in the full version of this paper \cite{cryptoeprint:2022/1498}.
