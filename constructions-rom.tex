...
\subsection{Constructions of Linearly Homomorphic Non-Malleable NITC}
...
\hline          
\end{tabular}
\caption{Construction of Linearly Homomorphic NITC in ROM}
...
\subsection{Constructions of Multiplicatively Homomorphic Non-Malleable NITC}
We define language for our construction of a linearly homomorphic NITC which relies on NIZKs in the ROM in the following way:
\[
L = \left\{(h_1, h_2, c_0, c_1, c_2)| \exists (m,r):
\begin{aligned}
...
\hline          
\end{tabular}
\caption{Construction of Multiplicatively Homomorphic NITC in ROM}
