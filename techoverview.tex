...
\paragraph{On the need for separate proofs in std model and ROM}
\ref{thm:SigmaROMFactoring}

Libert et al repeat underlying sigma protocol logarithmic number of times
\todo{move to ROM section? still doesn't explain why two separate proofs.}
