...
\item If there exists a decommitment query $(c, \pi_\com)$ such that $\dec(\crs, c, \pi_com, 1) \neq \dec(\crs,c, \pi_com, 2)$, then it returns $(c, \pi_\com)$. Note that such a query exists iff $\event$ happens.
\end{enumerate}
