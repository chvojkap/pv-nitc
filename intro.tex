...
\hline
\end{tabular}
\caption{\label{tab:comparison-NITC}Comparison of our construction with \cite{CCS:TCLM21} for security level $\secpar = 128$ bits and taking into account security loss.}
\end{center}
\end{table}
