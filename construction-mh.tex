...
& return 0 \\
                                             &\\
$\underline{\fdecom(\crs,c)}$ & $\underline{\eval(\crs,\otimes, c_1, \dots, c_n)}$ \\
...
\hline          
\end{tabular}
\caption{Construction of Multiplicatively Homomorphic NITC in Standard Model}
\label{table:nitc-mh}
\end{center}
\end{figure}
