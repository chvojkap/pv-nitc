...
\hline          
\end{tabular}
\caption{Construction of Linearly Homomorphic NITC in Standard Model}
\label{table:nitc-lh}
\end{center}
\end{figure}
...
\vspace{-2mm}
\begin{enumerate}
\item Sets $\crs:=\mathlist(N, T(\secpar), g, h_1, h_2, h_3, \crs_\nizk)$. and runs $(m_0, m_1, \st) \leftarrow \adv_{1, \secpar}(\crs)$ and answers decommitment queries using $k_1$.
