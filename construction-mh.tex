...
The construction described in this section is very similar to that from \Cref{sec:linearNITCstdmodel}, except that we replace Paillier encryption with ElGamal to obtain a multiplicative homomorphism. Also the proof follows the same high-level outline, but is different in some details, and therefore we give a full proof, too. We use a SS-NIZK for the following language: 
